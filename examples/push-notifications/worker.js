// Based off of https://ponyfoo.com/articles/backgroundsync
const version = 'v1::'
...
self.addEventListener('sync', event => {
  ...
  event.tag === 'fetchDog' && event.waitUntil(fetchDogImage())
})
...
function fetchDogImage () {
  fetch('./hasLanded.png')
    .then(res => res)
    .then(text => {
      console.log('WORKER: Request successful', text)
    })
    .catch(error => {
      console.log('WORKER: Request failed', error)
    })
}